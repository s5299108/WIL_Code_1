...
export default Home = function ({navigation}) {
    ...
    return (
        <View style={styles.container}>
          ...
          <Text> Encrypt the plaintext "ATTACKATDAWN" using a rail fence cipher with 4 rails.</Text>
        ...
        <Text style={styles.hint}>
         Write the plaintext in a zigzag pattern across the number of rails, and then read off the ciphertext row by row. The first row being / A . . . K . . . W/
        </Text>
      )}
