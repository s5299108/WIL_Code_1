...
export default Home = function ({navigation}) {
    ...
    const navToCorrect = () => {
        if (value === 'WITH SHINGHT') {
            navigation.navigate('Correct_14');
        } else {
    ...
    return (
        <View style={styles.container}>
          ...
          <Text> </Text>
          <Text> </Text>
          <Text>Decrypt the ciphertext "DRGS HSRMTSG" using the Atbash cipher. </Text>
          <Text> </Text>
        ...
        <Text style={styles.hint}>
          Map each letter of the ciphertext to its reverse in the alphabet.
        </Text>
      )}
